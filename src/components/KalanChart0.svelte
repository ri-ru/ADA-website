    ...
    var option = {
                ...
                legend: {
                    ...
                    data: [
                        {
                            name: "Misc",
                            icon: "path://M946.406 130.625c28.125 -11.7188 60.2344 -5.15625 81.7969 16.1719l150 150c14.0625 14.0625 22.0312 33.0469 22.0312 52.9688s-7.96875 38.9062 -22.0312 52.9688l-150 150c-21.5625 21.5625 -53.6719 27.8906 -81.7969 16.1719s-46.4062 -38.9062 -46.4062 -69.375 v-74.5312h-75c-23.6719 0 -45.9375 11.0156 -60 30l-99.375 132.422l-93.75 -124.922l73.125 -97.5c42.4219 -56.7188 109.219 -90 180 -90h75v-75c0 -30.2344 18.2812 -57.6562 46.4062 -69.375zM384.375 712.578l93.75 124.922l-73.125 97.5 c-42.4219 56.7188 -109.219 90 -180 90h-150c-41.4844 0 -75 -33.5156 -75 -75s33.5156 -75 75 -75h150c23.6719 0 45.9375 -11.0156 60 -30zM1027.97 1153.2c-21.5625 21.5625 -53.6719 27.8906 -81.7969 16.1719s-46.4062 -38.9062 -46.4062 -69.375v-75h-74.7656 c-70.7812 0 -137.578 -33.2812 -180 -90l-360 -480c-14.0625 -18.9844 -36.3281 -30 -60 -30h-150c-41.4844 0 -75 -33.5156 -75 -75s33.5156 -75 75 -75h150c70.7812 0 137.578 33.2812 180 90l360 480c14.0625 18.9844 36.3281 30 60 30h75v-75 c0 -30.2344 18.2812 -57.6562 46.4062 -69.375s60.2344 -5.15625 81.7969 16.1719l150 150c14.0625 14.0625 22.0312 33.0469 22.0312 52.9688s-7.96875 38.9062 -22.0312 52.9688l-150 150z",
                        },
                        {
                            name: "Autos & Vehicles",
                ...
                series: [
                    {
                        ...
                        tooltip: {
                            ...
                            formatter: function (param) {
                                const totals = [
                                    332, 23294, 137250, 338040, 694586, 1085424,
                                    1874984, 2926397, 4018275, 5179934, 6808072,
                                    9352770, 12486407, 15275859, 12723124,
                                ];
                                const count = Math.round(
                                    totals[param.dataIndex] * param.data,
                                );
                                const label =
                                    count.toString() +
                                    " / " +
                        ...
                        data: [
                            0.0, 0.0, 0.0007285974499089253, 0.0, 0.0,
                            0.00009212989578266189, 0.0,
                            0.000034171713543992835, 0.0, 0.0, 0.0, 0.0,
                            8.008708990504635e-6, 6.5462767102000615e-6, 0.0,
                        ],
                    },
                    {
                        type: "line",
                        ...
                        data: [
                            0.0, 0.0, 0.002185792349726776,
                            0.014495325996923441, 0.00849426852830319,
                            0.014740783325225902, 0.011360096939493884,
                            0.011481695750781593, 0.012642240762516254,
                            0.013166190920579296, 0.011794822381431924,
                            0.013632324968966414, 0.015280616753882842,
                            0.015697971551059748, 0.02130765997407555,
                        ],
                    },
                    {
                        type: "line",
                        ...
                        data: [
                            0.0, 0.08585901948999743, 0.08670309653916211,
                            0.06981422316885576, 0.06665841234922673,
                            0.04403809018411239, 0.030933597300030292,
                            0.03307821871058506, 0.03461684429263801,
                            0.032606593056977176, 0.035090698218232706,
                            0.03228989914217927, 0.034645675092923045,
                            0.034669081457219524, 0.04392003096094953,
                        ],
                    },
                    {
                        type: "line",
                        ...
                        data: [
                            0.0, 0.0, 0.058287795992714025, 0.13193704886995622,
                            0.08134341895747971, 0.05186913132563865,
                            0.06320053931126879, 0.0653363162961143,
                            0.05524758758422457, 0.04976897389040092,
                            0.05359814056020559, 0.05525635720754386,
                            0.07879768775757509, 0.08157970036251316,
                            0.09434003787120207,
                        ],
                    },
                    {
                        ...
                        data: [
                            0.0, 0.14166738215849575, 0.126775956284153,
                            0.1390368003786534, 0.1138807865404716,
                            0.09323545453205383, 0.08293404103715019,
                            0.09086258631347695, 0.13896510318482433,
                            0.10789712764680014, 0.11147061899462873,
                            0.10558369338709281, 0.11275461387731475,
                    ...
                    },
                    {
                        ...
                        data: [
                            0.0, 0.04722246071949859, 0.044444444444444446,
                            0.028399006034788784, 0.02865015995139551,
                            0.03077138519140907, 0.09200078507336595,
                            0.03297570356995309, 0.025757321238591188,
                            0.02565669755637813, 0.03632452770769757,
                            0.0303118755192312, 0.03013677193126894,
                            0.031611970233556094, 0.03683057714441831,
                        ],
                    },
                    {
                        type: "line",
                        ...
                        data: [
                            0.0, 0